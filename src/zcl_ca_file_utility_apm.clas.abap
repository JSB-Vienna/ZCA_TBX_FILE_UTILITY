...
CLASS zcl_ca_file_utility_apm DEFINITION PUBLIC
                                         FINAL
                                         CREATE PUBLIC.
...
CLASS ZCL_CA_FILE_UTILITY_APM IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    zif_apack_manifest~descriptor =
         VALUE #(
            group_id        = 'itinere.at'
            artifact_id     = 'zca_tbx_file_utility'
            version         = '0.1.0'
            repository_type = 'abapGit'
            git_url         = 'https://github.com/JSB-Vienna/zca_file_utility.git'
            dependencies    = VALUE #(
                                  ( group_id       = 'itinere.at'
