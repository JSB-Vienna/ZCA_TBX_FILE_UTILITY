...
*   i n s t a n c e   m e t h o d s
    METHODS:
      ...
      "! @parameter iv_sel_field_id     | <p class="shorttext synchronized" lang="en">Selection field Id as assignment to a file/directory</p>
      ...
      constructor
        IMPORTING
          ...
          iv_sel_field_id TYPE num1 DEFAULT zcl_ca_c_file_utility=>selection_field_id-for_file_1
...
*    sel_field_names-location-memory_id    = |ZCA_FL{ mv_sel_field_id }| ##no_text.
...
*    ms_selscr_names-path_type-memory_id    = |ZCA_FT{ mv_sel_field_id }| ##no_text.
    sel_field_names-path_type-modif_id     = |FT{ sel_field_id }| ##no_text.
    sel_field_names-path_type-user_command = |PATHTYPE_{ sel_field_id }_CHANGED| ##no_text.
...
*    ms_selscr_names-path-user_command = |PATH_{ mv_sel_field_id }_CHANGED| ##no_text.
...
*    ms_selscr_names-file_name-user_command = |FILE_NAME_{ mv_sel_field_id }_CHANGED| ##no_text.

    sel_field_names-operation-field_name   = |P_FL{ sel_field_id }OP| ##no_text.
*    ms_selscr_names-operation-memory_id    = |ZCA_FO{ mv_sel_field_id }| ##no_text.
...
*    ms_selscr_names-mode-memory_id    = |ZCA_FM{ mv_sel_field_id }| ##no_text.
  ...
  METHOD modify_selection_fields.
    ...
    DATA(lv_name_pattern)   = CONV sychar132( |*FL{ sel_field_id }*BLOCK*| ) ##no_text.
    DATA(lv_group1_pattern) = CONV char3( |F+{ sel_field_id }| ) ##no_text.
